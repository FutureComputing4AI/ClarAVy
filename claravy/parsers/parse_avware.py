...
class Parse_Avware: # Uses Vipre engine
    ...
    def __init__(self):
        self.parse_delim_fmt = {
            ...
            "TOK.TOK.TOK-TOK-TOK.TOK (TOK)": self.parse_delim_fmt23
        }
    ...
    def parse_delim_fmt6(self, tokens):
        return [CAT, CAT, FILE, FAM, SUF, NULL]
    ...
    def parse_delim_fmt22(self, tokens):
        return [PRE, FILE, VULN, VULN, VULN, SUF, NULL]

    # TOK.TOK.TOK-TOK-TOK.TOK (TOK)
    def parse_delim_fmt23(self, tokens):
        return [PRE, FILE, VULN, VULN, VULN, SUF, SUF, NULL]
